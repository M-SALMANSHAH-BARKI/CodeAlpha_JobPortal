...
const Banner = ({query , handleInputChange }) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        ...
        <p className='text-lg text-black/70 mb-8'>Thousands of Jobs in Computer , Engineering and Technology sectors are wainting for you.</p>
        ...
        <form> 
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                ...
                <button type="submit" className='bg-blue text-white py-2 px-8 md:rounded-s-none rounded'>Search</button>
            </div>
        </form>
